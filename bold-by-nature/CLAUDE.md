...
- `microsite/bold-by-nature.html` — the public web version of the proposal,
  live at https://receivedwisdom.llc/boldbynature.html. Working source lives
  here; it publishes to the `received-wisdom-site` repo (Cloudflare Pages) as
  `boldbynature.html` via the PR-to-deploy flow in the root CLAUDE.md. When this file changes, republish by copying it over there.
