...
Copy a prompt below into Gemini (Nano Banana / Imagine). Start with **Prompt A (hero shot)**.
Tips: ask for **16:9**, generate 3–4 variations, then iterate ("keep everything, but make the
roofs flatter / the glass taller / more snow"). Photorealistic architectural-visualization style.
You can also upload a High Horse Ranch photo + the `site-plan-schematic.svg` as reference images
and say "match this material palette and this three-building arc layout."
...
> photography, high dynamic range. 16:9.
>
> Negative: no pitched/gabled roofs, no suburban houses, no visible power lines, no fussy
> ornament, no railings or clutter, no people, not cartoonish, not a rendering-gray look.
...
> house clad in **weathering Cor-Ten steel and warm reclaimed wood**, flat roof with a deep
> overhang and thin fascia, a recessed entry with a single large door, very few windows on this
> face, a stacked-firewood nook. Gravel motor court in foreground, sagebrush, the roofline of two
> smaller matching pavilions visible to either side, snow-capped Teton peaks beyond the roofs.
> Overcast soft light, calm, minimal, KieranTimberlake High Horse Ranch style. 16:9.
> Negative: no pitched roof, no large glass on this side, no suburban details, no clutter.

## Prompt D — interior, looking out the view wall
> Photorealistic interior of a warm minimalist single-story home, standing in an open living
> space looking out through a **full-height, full-width wall of glass** at the snow-capped Teton
> Range. Reclaimed Douglas-fir ceiling with exposed structure and a deep overhang shading the
> glass, polished concrete floor, Cor-Ten and wood accents, a low fireplace, spare furnishings.
> Warm morning light, alpenglow on the peaks. KieranTimberlake High Horse Ranch aesthetic. 16:9.
> Negative: no clutter, no ornate furniture, no small punched windows.
