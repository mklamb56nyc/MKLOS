# Portugal Nº 19 — budget (researched 2026-07-23)

Priced from published rates and current fare patterns — **no live inventory was
checked** (Delta/Marriott don't expose it outside their booking engines), so
every line needs confirmation at booking. Ranges are for **two people**.
...
- **The GUC play already pulled the flight line down ~$3.5–4k** vs. all-cash
  Delta One. Residual flight risk: GUC space not clearing on the Oct 8
...
1. Delta One cash + award pricing for Oct 8 out / Oct 12 back (exact October
   schedule publishes with the fare).
2. Penha Longa Oct 9–12 availability — Columbus Day weekend; book refundable.
3. Oitavos tee sheet (their teeone.golf engine) + West Cliffs booking; confirm
   official green fees and Carrie's tee options.
4. Chocapalha private tasting (appointment only — no published price).
5. Saturday driver quote for golf → lunch → quinta → resort loop.

## Sources
Fares/rates as found 2026-07-23: businessclasstravel.us (JFK–LIS biz fare
ranges), Kayak (Penha Longa from-rates), teetimes.pt / lisbonpackage.com /
costalessgolf.com (green-fee ranges), midoripenhalonga.com menu PDF (Kiri
€154 / Yama €186, pairings €80/€115), restaurant aggregators for LAB (€158 /
€192), lisbonprivatetours.com + Rick Steves forum (driver day rates).
